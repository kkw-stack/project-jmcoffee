                ...
                <div class="jt-single__body">
                    ...
                    <div class="jt-single__pagination">
                        <?php if ( ! empty( $prev_post_id ) ) : ?>
                            <a class="jt-single__pagination-link jt-single__pagination-link--prev" href="<?php echo get_permalink( $prev_post_id ); ?>">
                        ...
                        <?php if ( ! empty( $next_post_id ) ) : ?>
                            <a class="jt-single__pagination-link jt-single__pagination-link--next" href="<?php echo get_permalink( $next_post_id ); ?>">
                    ...
                    <div class="jt-single__control">
                        <a class="jt-btn__underline" href="<?php the_permalink($jt_module->_pageid); ?>"><span><?php _e( 'Go to list', 'jt' ); ?></span></a>
